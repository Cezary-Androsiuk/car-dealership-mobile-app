...
Item {
    ...
    ListView{
        ...
        delegate: Item{
            id: row
            width: refreshingListView.width
            height: thumbnailContainer.height +4 +4
            ...
            Item{
                ...
                Image{
                    id: thumbnailImage
                    width: row.extended? (extendButtonSeparator.x -4 -4) : 120
                    height: row.extended? (width * modelData.thumbnailRatio) : width * (9.0/16.0)
